from PyQt6.QtWidgets import QTextBrowser, QTextEdit, QApplication, QComboBox, QWidget, QLabel, QPushButton
...
class Window(QWidget):
    def __init__(self):
        ...
        self.combo_input_base.setStyleSheet("background-color:white")
        ...
        self.combo_output_base.setStyleSheet("background-color:white")
        ...
        self.txt_output.setStyleSheet("background-color:white")
    ...
    def convert(self):
        try:
            assert self.txt_input.toPlainText() != ""
